...
#     ]
#
# print("Distribution of target variable (Rings):")
...
#
# # 1. Gradient Boosting with anti-overfitting settings
# gb = Pipeline([
#     ("prep", preprocess),
...
#
# # 2. XGBoost with anti-overfitting settings
# xgb = Pipeline([
#     ("prep", preprocess),
#     ("model", XGBRegressor(
#         n_estimators=500,
...
#
# # 3. RandomForest with anti-overfitting settings
# rf = Pipeline([
#     ("prep", preprocess),
...
#         print(f"Displaying feature importance is not possible: {e}")
#
# # Save best model
# # import joblib
# #
